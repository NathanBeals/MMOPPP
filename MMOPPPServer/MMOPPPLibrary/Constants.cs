...
namespace MMOPPPLibrary
{
    public static class Constants
    {
        ...
        public const string ServerPublicAddress = "natelovesbread.ddns.net";
        ...
        //TODO: for now I'm going to use these to test connections but in the future I will have to
        // send a udp down port number so that connections using the same IP address can be allowed to connect at the same time
        public const Int32 TempClientPort = 9999;
    }
